...
void print_board_view()
{
    ...
    printf("\n|---:---:---|---:---:---|---:---:---|\n");
    printf("| %c : %c : %c | %c : %c : %c | %c : %c : %c |", board[8][0], board[8][1], board[8][2], board[8][3], board[8][4], board[8][5], board[7][6], board[7][7], board[7][8]);
    printf("\n=====================================\n");
}
...
int main(void)
{
    ...
    update_board(0, 0, 2);       // updates row 1, column 1 to be equal to 2
    printf("%c\n", board[0][0]); // prints row 1, column 1
    print_board_view();          // prints the updated board view
    reset_board();
    printf("%c\n", board[0][1]); // prints row 1, column 1
    print_board_view();
}
